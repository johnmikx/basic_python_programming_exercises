...
# - Objective: I will create a program that asks for numbers until invalid input and displays the highest number.
# - Scope: Continuous user input and maximum value tracking
# - Resources: Python
...
#     - Display the highest number at the end
...
#           3.1.1. Find the largest number using `max()`
#           3.1.2. Print the highest number
...
# Test Case 1: All positive numbers -> Should display largest positive
# Test Case 2: All negative numbers -> Should display largest negative
# Test Case 3: Mix of positive and negative -> Should display largest overall
