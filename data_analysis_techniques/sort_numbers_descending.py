...
# - Objective: I will create a program that asks for numbers until invalid input and displays them sorted from highest to lowest.
...
#           3.1.1. Sort the list in descending order
#           3.1.2. Print "Numbers sorted from highest to lowest:"
...
# Test Case 1: Already reverse sorted inputs -> Should display in same order
# Test Case 2: Sorted inputs -> Should display in reverse of input order
# Test Case 3: Random order inputs -> Should display in descending order
